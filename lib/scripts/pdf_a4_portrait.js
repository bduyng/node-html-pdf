...
page.onLoadFinished = function (status) {
  ...
  try {
    ...
    console.log('[BDUYNG HTML-PDF] page.onLoadFinished > page.render > err', err)
    return exit(err)
  }
...
function getContent (page) {
  return page.evaluate(function () {
    ...
    console.log('[BDUYNG HTML-PDF] getContent > returnedObj', JSON.stringify(returnedObj, null, 2))
    return returnedObj
  })
}
